...
function function2(){
	...
	var logout1 = document.getElementById("log");

	if(userbox2.classList.contains("hiddenuser") == true)
	{
		userbox2.className = "activeuser";
		username.innerHTML = "<?php echo "Hello ". $_SESSION['username'];?>";
		logout1.innerHTML = "Logout";
	}
	else
	{
		userbox2.className = "hiddenuser";
...
function chatFunction(){
	...
	else
	{
		...
		if(textchat.classList.contains("textactive")==true)
		{
...
<div id='hiddenmenu'  class="myhover"></div>
<p id='hiddenmenu2'  class="myhover2"></p>
<div id='user' class='userButtclicked' onclick="function2()" >
	User
</div>

<div id='userbox' class='hiddenuser'>
	<a id='username' href='#'></a>>
	<a id='log' class="logoutbutt" onclick="chatF()"></a>
</div>

<div id='friendB' class="friendButton" onclick="friendF()">Friends</div>
